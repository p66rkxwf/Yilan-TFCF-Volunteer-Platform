    ...
    <>
      ...
      <main className="grow flex flex-col md:flex-row">
        ...
        <section className="relative flex-1 group overflow-hidden border-b md:border-b-0 md:border-r border-slate-200">
          ...
          <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate pointer-events-none absolute -right-8 -bottom-8 text-[220px] leading-none text-white/5 transition-transform duration-700 group-hover:scale-110">
            school
          </span>
          <div className="relative h-full flex flex-col justify-center items-center text-center p-8 md:p-16 z-10 min-h-[55vh] md:min-h-[60vh]">
            <div className="mb-6 p-4 rounded-full bg-white/10 backdrop-blur-md text-white">
              <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-4xl">school</span>
            </div>
        ...
        <section className="relative flex-1 group overflow-hidden">
          ...
          <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate pointer-events-none absolute -left-8 -bottom-8 text-[220px] leading-none text-white/5 transition-transform duration-700 group-hover:scale-110">
            volunteer_activism
          </span>
          <div className="relative h-full flex flex-col justify-center items-center text-center p-8 md:p-16 z-10 min-h-[55vh] md:min-h-[60vh]">
            <div className="mb-6 p-4 rounded-full bg-white/10 backdrop-blur-md text-white">
              <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-4xl">volunteer_activism</span>
            </div>
            <h2 className="text-white text-3xl md:text-5xl font-black mb-8 tracking-tight">
              志工報名專區
            </h2>
            ...
            <ul className="divide-y divide-slate-100">
              {latest.map((item) => (
                <li key={item.id}>
                  ...
                  >
                    {item.is_pinned && (
                      <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate shrink-0 text-[18px] text-amber-500">
                        push_pin
                      </span>
                    )}
