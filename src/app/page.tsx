    ...
    <main className="flex flex-col md:flex-row flex-1 w-full min-h-[calc(100vh-80px)]">
      ...
      >
        <div className="flex flex-col items-center space-y-6 text-center"> {/* 使用 space-y-6 增加垂直間距 */}
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-blue-600 group-hover:scale-105 transition-transform duration-500">
            獎學金專區
          </h2>
      ...
      >
        <div className="flex flex-col items-center space-y-6 text-center">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-indigo-600 group-hover:scale-105 transition-transform duration-500">
            志工專區
          </h2>
          <p className="text-lg sm:text-xl text-gray-500 max-w-sm">
