          ...
          {verified === null ? (
            ...
            <div className="rounded-md border border-emerald-200 bg-emerald-50 p-6">
              <p className="flex items-center gap-2 text-sm font-semibold text-emerald-700">
                <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-[20px]">verified</span>
            ...
            <div className="rounded-md border border-slate-200 bg-white p-6">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                ...
                >
                  <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-[18px]">mail</span>
