...
const SIDEBAR_ITEMS = [
  { icon: "person", label: "個人資料", href: "/profile", active: true },
  { icon: "description", label: "我的報名", href: "#", active: false },
  { icon: "bookmark", label: "收藏項目", href: "#", active: false },
  { icon: "settings", label: "帳號設定", href: "#", active: false },
];
                          ...
                          >
                            <div className="flex justify-between items-start mb-2">
                              <h4 className="font-bold text-sm">
                                {reg.activities?.title || "未知活動"}
                              </h4>
                              <span
                                className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${s.color}`}
                              >
                                {s.label}
                              </span>
                            </div>
