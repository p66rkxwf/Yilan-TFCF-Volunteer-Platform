      ...
      <div className="flex w-full flex-col">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="flex h-12 flex-1 items-stretch rounded-lg border border-slate-200 bg-white shadow-sm">
            <div className="flex items-center justify-center pl-4 text-slate-400">
              <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate">search</span>
            </div>
            <input
        ...
        {filtered.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-x-8 gap-y-2 text-sm text-slate-700">
                      <span className="inline-flex items-center gap-1.5">
                        <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-[18px] text-slate-400">
                          calendar_today
                        </span>
                        <span>
          ...
          <div className="py-16 text-center text-slate-400">
            <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate mb-3 block text-5xl">search_off</span>
            <p className="text-sm">
