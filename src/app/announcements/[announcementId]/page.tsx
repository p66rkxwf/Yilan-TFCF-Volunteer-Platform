    ...
    <main className="w-full flex-1 bg-white">
      ...
      {!announcement ? (
        <div className="py-16 text-center">
          <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate mb-2 text-4xl text-slate-300">
            search_off
          </span>
        ...
        <article className="rounded-md border border-slate-200 bg-white p-5 sm:p-6">
          <div className="flex items-start gap-2 border-b border-slate-200 pb-4">
            {announcement.is_pinned && (
              <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate mt-0.5 shrink-0 text-[19px] text-amber-500">
                push_pin
              </span>
            )}
            <div>
