  ...
  return (
    ...
    >
      <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-primary px-2.5 py-0.5 text-xs font-bold text-white">
        <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-[15px]">campaign</span>
        公告
      </span>
      ...
      <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate shrink-0 text-[18px] text-primary/60 transition-transform group-hover:translate-x-0.5">
        chevron_right
      </span>
    </Link>
  );
