      ...
      <div className="flex max-w-[480px] flex-1 flex-col gap-8">
        ...
        <div className="flex flex-col items-center gap-6 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-6 py-10">
          <div className="flex size-14 items-center justify-center rounded-full bg-primary/10 text-primary">
            <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-3xl">support_agent</span>
          </div>
        ...
        <div className="flex items-center justify-center">
          ...
          >
            <span translate="no" aria-hidden="true" className="material-symbols-outlined notranslate text-lg">arrow_back</span>
            返回登入
          </Link>
        </div>
      </div>
